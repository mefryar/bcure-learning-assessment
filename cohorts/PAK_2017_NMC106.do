...
*		Lahore, Pakistan for officers in the 106th National Management
*		Cohort. The trainings took place from May 2-3 and covered the
*		BCURE modules: Systematic Approaches to Policy Decisions (SYS), 
*		and Becoming an Effective Consumer of Impact Evaluations (IMP).
* Uses: 	PAK_2017_NMC106_Pre.csv, PAK_2017_NMC106_Post.csv 
* Creates: 	PAK_2017_NMC106.dta, PAK_2017_NMC106_score.xlsx
...
if r(N) != 0 {
	...
	must be examined and regrouped manually */
		...
		assert cohort[1] == "pak_2017_nmc106"
