...
*		training held at two of the National Institutes of Management
*		which are the constituent units of the National School of 
*		Public Policy in Pakistan for officers in the 20th Senior
*		Management Cohort. The trainings took place from Oct. 18-19
*		at NIM Karachi, Dec. 1-2 at NIM Lahore. Each training covered 
*		the BCURE modules: Systematic Approaches to Policy Decisions 
*		(SYS), and Becoming an Effective Consumer of Impact Evaluations 
*		(IMP).
* Uses: 	PAK_2016_SMC20_Karachi_Pre.csv,
*		PAK_2016_SMC20_Lahore_Pre.csv,
*		PAK_2015_SMC20_Karachi_Post.csv,
*		PAK_2016_SMC20_Lahore_Post.csv, 
* Creates: 	PAK_2016_SMC20.dta
...
forval i = 1/2 {
	...
	four files */
	forval j = 1/2 {
		local campus: word `j' of "karachi" "lahore"
...
if r(N) != 0 {
	...
	must be examined and regrouped manually */
		...
		assert cohort[1] == "pak_2016_smc20"
		
		forv i = 1/5 {
			local pre_group: word `i' of   3  4 15 19 24 
			local post_group: word `i' of 27 34 31 33 28
