...
*		training held from March 20 to 23, 2017 at the Nepal 
*		Administrative Staff College covering all six of the 
...
* Uses: 	NPL_2017_NASC_Pre.csv, NPL_2017_NASC_Post.csv
* Creates: 	NPL_2017_NASC.dta
