...
*		Public Policy in Pakistan for officers in the 19th Senior
*		Management Cohort. The trainings took place from May 26-27 at
*		NIM Karachi, June 2-3 at NIM Lahore, and June 13-14 at NIM 
*		Islamabad. Each training covered the BCURE modules: Systematic 
*		Approaches to Policy Decisions (SYS), and Becoming an Effective 
*		Consumer of Impact Evaluations (IMP).
* Uses: 	PAK_2016_SMC19_Islamabad_Pre.csv,
*		PAK_2016_SMC19_Karachi_Pre.csv,
*		PAK_2016_SMC19_Lahore_Pre.csv,
*		PAK_2015_SMC19_Islamabad_Post.csv,
*		PAK_2015_SMC19_Karachi_Post.csv,
*		PAK_2016_SMC19_Lahore_Post.csv, 
* Creates: 	PAK_2016_SMC19.dta
...
if r(N) != 0 {
	...
	must be examined and regrouped manually */
		...
		assert cohort[1] == "pak_2016_smc19"
		
		replace group = 9 if group == 19
