...
*		training held from July 19 to 20, 2016 at the Nepal 
*		Administrative Staff College covering the BCURE modules on 
*		Becoming an Effective Consumer of Descriptive Evidence (DES)
*		and Becoming an Effective Consumer of Impact Evaluations (IMP).
* Uses: 	NPL_2016_NASC_Pre.csv, NPL_2016_NASC_Post.csv
* Creates: 	NPL_2016_NASC.dta
