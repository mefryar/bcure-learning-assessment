...
*		Public Policy in Pakistan for officers in the 21st Senior
*		Management Cohort. The trainings took place from April 3-5 at
*		NIM Karachi, April 24-25 at NIM Islamabad, and June 8-9 at NIM
*		Lahore. Each training covered the BCURE modules: Systematic 
*		Approaches to Policy Decisions (SYS) and Becoming an Effective 
*		Consumer of Impact Evaluations (IMP).
* Uses: 	PAK_2017_SMC21_Islamabad_Pre.csv, 
*		PAK_2017_SMC21_Karachi_Pre.csv, 
*		PAK_2017_SMC21_Lahore_Pre.csv, 
*		PAK_2017_SMC21_Islamabad_Post.csv 
*		PAK_2017_SMC21_Karachi_Post.csv
*		PAK_2017_SMC21_Lahore_Post.csv, 
* Creates: 	PAK_2017_SMC21.dta, pak_2017_smc21_karachi_scores.xlsx,
*		pak_2017_smc21_islamabad_scores.xlsx, 
*		pak_2017_smc21_lahore_scores.xlsx,
...
forval i = 1/2 {
	...
	/* Since training was administered on two campuses, we need to clean 
	four files */
	forval j = 1/3 {
...
if r(N) != 0 {
	...
	must be examined and regrouped manually */
		...
		assert cohort[1] == "pak_2017_smc21"
		
		// Manually ungroup those with strgroup incorrectly grouped 
		replace group = 30 if fullname == "Ijaz Ahmad"

		/* Manually group those which strgroup failed to group
		correctly */
		forv i = 1/3 {
			local pre_group: word `i' of  16 18 21
			local post_group: word `i' of  1  3  5
