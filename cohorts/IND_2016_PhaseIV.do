...
*		training held from June 30 to July 1, 2017 for the IAS Officers 
*		participating in the Phase IV Mid Career Training Program at 
*		the Lal Bahadur Shastri National Academy of Administration 
*		covering the BCURE modules on Systematic Approaches to Policy 
*		Decisions (SYS) and Becoming an Effective Consumer of 
*		Descriptive Evidence (DES). 
* Uses: 	IND_2016_PhaseIV_Pre.csv, IND_2016_PhaseIV_Post.csv
* Creates: 	IND_2016_PhaseIV.dta
...
if r(N) != 0 {
	...
	must be examined and regrouped manually */
		...
		assert cohort[1] == "ind_2016_phaseiv"

		forv i = 1/3 {
			local pre_group: word `i' of 10 11 12
			local post_group: word `i' of 1 4 5
