...
*		Lahore, Pakistan for officers in the 18th Senior Management 
*		Cohort. The training took place on December 21 and covered the 
*		BCURE modules: Systematic Approaches to Policy Decisions (SYS), 
*		Becoming an Effective Consumer of Impact Evaluations (IMP).
* Uses: 	PAK_2015_SMC18_Lahore_Pre.csv, PAK_2015_SMC18_Lahore_Post.csv
* Creates: 	PAK_2015_SMC18.dta
...
if r(N) != 0 {
	...
	must be examined and regrouped manually */
		...
		assert cohort[1] == "pak_2015_smc18"
		
		forv i = 1/5 {
			local pre_group: word `i' of   1  2  4  5  8 
			local post_group: word `i' of 10 13 15 14 17
